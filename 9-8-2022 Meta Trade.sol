...
contract MetaTrade is IERC20 {
    ...
    string constant private _name = "Meta Trade";
    string constant private _symbol = "MTA";
    ...
    address payable public marketingWallet = payable(0x9A9FEAbe18CB5903F91d8462A23E2dc56665b404);
...
//===============================================================================================================
    ...
    function setTaxes(uint16 buyFee, uint16 sellFee, uint16 transferFee) external onlyOwner {
        ...
        require(transferFee <= maxTransferTaxes,
